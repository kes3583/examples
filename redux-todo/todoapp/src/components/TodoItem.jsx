...
import {toggleCompleteAsync, updateTodoAsync, deleteTodoAsync } from '../redux/todoSlice'
...
function TodoItem({todo}) {
    ...
    const onToggle = () => {
        dispatch(toggleCompleteAsync({id: todo.id, isCompleted: !todo.isCompleted}))
    }
        ...
        <div>
            <div className="row mx-2 align-items-center">
                ...
                <div className="col" onClick={onEditable}>
                    {editable ?
                        <input type="text" className="col form-control" value={todoText} onChange={onChangeTodoText}
                               placeholder={todoText}/> : <h4>{todo.text}</h4>}
                </div>
